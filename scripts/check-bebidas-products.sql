-- Verificar se existem produtos de bebidas
SELECT 
  p.id,
  p.name,
  p.codigo,
...
-- Verificar o ID da categoria Bebidas
SELECT id, name FROM categories WHERE name = 'Bebidas';
...
-- Bebidas (usando o ID da categoria Bebidas)
